...
function getStr(imgSrc) {
	...
	}else if(imgSrc.indexOf("2018-06-03_210405") != -1||imgSrc.indexOf("2018-06-03_210214") != -1) {
		return '下长红，短下一般或者短下集束远，现价确认线两个都有折。';
	...
	}else if(imgSrc.indexOf("2018-06-25_200633") != -1) {
		return '下长红,向上－集束远，现价确认线距离变大的趋势线向下，现价确认线距离变小的趋势线向上，直上的可以有折，但是缓上的没有折并且一直向上。';
	}else if(imgSrc.indexOf("2018-06-02_151448") != -1) {
		return '上白绿下，下集，趋势线前散的现折缓。';
	}
